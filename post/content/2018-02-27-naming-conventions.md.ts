...
import { hr_, p_ } from 'relementjs/html'
...
+ md__raw_({ ctx }, lines_(
	`An Abstraction name encodes the meaning & context of the abstraction. The name consists of tags that are joined together to create a name. ${
		tb_a_({ href: 'https://en.wikipedia.org/wiki/Naming_convention_(programming)', nofollow: true }, 'Naming Convention (programming) (Wikipedia)')
	}`
))
