...
+ dl_tree_({ ctx, _: sticky_h2__dl_tree_props_ }, ()=>[
    ...
    `1. Select the Lighthouse tab at the top menu. You may have to press the ${heroicons_chevron_double_right_({ class: 'inline-block m-0 h-6 w-6'})} icon at the right to see the Lighthouse tool
       ${img_({
		...
		nl,
		`Keep in mind that this site scores at 100 across the board (performance, accessibility, best practices, seo)${
			footnote__sup_({ ctx, id: 'briantakita-me-100' }, [
				`briantakita.me lighthouse ${lighthouse__iframe_(url__join(bucket_url, 'lighthouse/briantakita.me.html'), 'briantakita.me lighthouse')}`,])
		}. Also keep in mind that anything above 90 is considered a good score.`,]],
