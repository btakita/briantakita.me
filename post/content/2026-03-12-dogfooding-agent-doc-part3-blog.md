---
title: "Dog-fooding agent-doc Part 3: YouTube Upload in Rust, tmux-router Tests, and JetBrains Plugin IPC"
description: "Building developer tools live with AI — implementing YouTube's resumable upload protocol in Rust, writing 61 tmux-router tests, wiring JetBrains plugin IPC for real-time document patching, and reflections on chaos, consciousness, and vibe coding."
date: 2026-03-13
tags:
  - agent-doc
  - rust
  ...
  - existence-lang
  - live-coding
video_url: https://www.youtube.com/watch?v=RrZETW8EZEQ
---

# Dog-fooding agent-doc Part 3: YouTube Upload in Rust, tmux-router Tests, and JetBrains Plugin IPC

This is Part 3 of my dog-fooding series where I build features live using [agent-doc](https://crates.io/crates/agent-doc) as the development surface. The whole point of dog-fooding is that I'm using the tool I'm building to build the tool — and the rough edges I hit become the next features I ship.

This session covers a lot of ground: implementing YouTube's resumable upload protocol in [corky](https://github.com/btakita/corky) (my Rust correspondence toolkit), comprehensive test coverage for tmux-router, and a significant architectural shift in the JetBrains plugin — moving from direct file modification to IPC-based patch delivery.

<iframe width="560" height="315" src="https://www.youtube.com/embed/RrZETW8EZEQ" title="Dog-fooding agent-doc Part 3" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
## Sift, tag-path, and Existence Lang: Semantic Code Search

There's a thread running through this session about integrating [Existence Lang](https://existence-lang.github.io/) with the development workflow. The idea: use tag-path to decompose variable names and abstractions into semantic tags, then map those tags to an ontology.
...
- [Part 1: CRDT debugging, Existence Lang, reactive architecture](https://www.youtube.com/watch?v=B-9uI53cRVE)
- [Part 2: rmemo, tag-path, releasing v0.16.1](https://www.youtube.com/watch?v=qQCKVQHRQCI)
- **Part 3: YouTube upload, tmux-router tests, JetBrains plugin IPC** (this post)

## Links

- [agent-doc on crates.io](https://crates.io/crates/agent-doc)
- [corky on GitHub](https://github.com/btakita/corky)
- [Existence Lang](https://existence-lang.github.io/)
