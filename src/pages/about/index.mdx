...
<p>
	{[
		...
		<Rel dom={atb_existence_()}/>,
		`?" sprang a `,
		<Rel dom={atb_philosophy_()}/>,
		`.`
	]}
</p>
<p>
	{[
		...
		<Rel dom={
			atb_({ href: '/posts/magic-connections-with-the-philosophy-of-language'},
				`language`)
		}/>,
...
<h2>
	<Rel dom={atb_electric_universe_()}/>
</h2>
...
<p>
	{[
		...
		<Rel dom={atb_holochain_whitepaper_()}/>,
		` is worth a read. Here are some `,
		<Rel dom={
			atb_({ href: 'https://github.com/btakita/holochain-notes/blob/master/whitepaper.md' },
				'notes')
		}/>,
		`.`
	]}
...
<div>
	...
	<Rel dom={attribution_dev__add({ ctx })}/>
</div>
