...
<p>
	{[
		...
		<Rel dom={
			V_atb_naming_convention({ innerText: 'naming convention' })
		}/>,
...
<h2>
	<Rel dom={V_atb_backbone_signal()}/>
</h2>

<p>
	{[
		`I started using global state management with `,
		<Rel dom={V_atb_backbonejs()}/>,
		...
		<Rel dom={V_atb_rundavoo()}/>,
		`.`,
	]}
</p>

<h2>
	<Rel dom={V_atb_jasmine_flow()}/>
</h2>
...
<p>
	{[
		...
		<Rel dom={V_atb({ innerText: 'Sutou Kouhei', href: 'https://github.com/kou' })}/>,
		` in 2015.`
	]}
</p>
...
<p>
	{[
		...
		<Rel dom={V_atb_ruby_on_rails()}/>,
		` integration.`
	]}
</p>

<h2>
	<Rel dom={V_atb_desertrb()}/>
</h2>
...
<h2>
	<Rel dom={V_atb_generic_query_analyzer()}/>
</h2>

<p>
	{[
		`A query analyzer using `,
		<Rel dom={V_atb_ado_net()}/>,
		`. I built this tool to run SQL queries on the `,
		<Rel dom={V_atb_msaccess()}/>,
		` CRM database & `,
		<Rel dom={V_atb_msexcel()}/>,
		` @ `,
		<Rel dom={V_atb_ccrcorp()}/>,
		`. Written with `,
		<Rel dom={V_atb_c_sharp()}/>,
		`, `,
		<Rel dom={V_atb_ado_net()}/>,
		`, `,
		<Rel dom={V_atb_winforms()}/>,
		`.`
	]}
</p>
