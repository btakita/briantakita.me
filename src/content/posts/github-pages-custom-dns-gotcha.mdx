...
import { Atb_briantakita_com, Atb_github_pages } from '@btakita/ui--server--briantakita'
...
<p>
	{[
		...
		<Atb innerText="official instructions" href="https://help.github.com/articles/setting-up-a-custom-domain-with-pages"/>,
		' and ',
		<Atb innerText="github pages with namecheap" href="http://davidensinger.com/2013/03/setting-the-dns-for-github-pages-on-namecheap/"/>,
		'.'
	]}
</p>
