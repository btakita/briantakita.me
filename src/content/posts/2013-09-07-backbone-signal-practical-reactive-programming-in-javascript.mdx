...
import { V_atb_backbone_signal, V_atb_browserify, V_atb_nodejs, V_atb_rundavoo } from '@btakita/ui--server--briantakita'
...
<p>
	<Van dom={
		V_fragment(props,
			...
			V_atb({ ctx: props.ctx, innerText: 'Truthy', href: 'http://www.sitepoint.com/javascript-truthy-falsy/' }),
			`. So when `,
