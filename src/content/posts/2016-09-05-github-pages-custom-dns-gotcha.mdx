...
import { briantakita_com__tb_a_, github_pages__tb_a_ } from '@btakita/ui--server--briantakita'
...
<R $={p_(
	...
	tb_a_({ href: 'https://help.github.com/articles/setting-up-a-custom-domain-with-pages' }, 'official instructions'),
	` and `, tb_a_({ href: 'http://davidensinger.com/2013/03/setting-the-dns-for-github-pages-on-namecheap/' },
