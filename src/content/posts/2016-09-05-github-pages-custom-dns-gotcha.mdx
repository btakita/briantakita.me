...
import { V_atb_briantakita_com, V_atb_github_pages } from '@btakita/ui--server--briantakita'
...
<p>
	<Rel dom={
		fragment_(
			...
			V_atb({
				innerText: 'official instructions',
				href: 'https://help.github.com/articles/setting-up-a-custom-domain-with-pages'
			}),
			` and `,
			V_atb({
				innerText: 'github pages with namecheap',
				href: 'http://davidensinger.com/2013/03/setting-the-dns-for-github-pages-on-namecheap/' }),
			`.`)
	}/>
</p>
