...
import { ccrcorp__tb_a_ } from '@btakita/ui--server--briantakita'
...
<R $={p_(
	`One of the great things about Whidbey is ClickOnce Deployment. At `, ccrcorp__tb_a_(), `, I use it to deploy rich
