...
<p>
	{[
		...
		<A_target_blank href="https://github.com/btakita/backbone-signal">
			backbone-signal (github.com)
		</A_target_blank>,
		', which is a ',
...
<p>
	{[
		...
		<A_target_blank href="http://www.sitepoint.com/javascript-truthy-falsy/">
			Truthy
		</A_target_blank>,
		'. So when ',
...
<p>
	{[
		...
		<A_target_blank href="http://www.rundavoo.com">www.rundavoo.com</A_target_blank>,
		' and has been fun to use, especially with ',
		<A_target_blank href="http://nodejs.org/">node.js</A_target_blank>,
			' & ',
		<A_target_blank href="http://browserify.org/">Browserify</A_target_blank>,
