...
<p>
	{[
		...
		<Atb innerText="backbone-signal (github.com)" href="https://github.com/btakita/backbone-signal"/>,
		', which is a ',
...
<p>
	{[
		...
		<Atb innerText="www.rundavoo.com" href="http://www.rundavoo.com"/>,
		' and has been fun to use, especially with ',
		<Atb innerText="node.js" href="http://nodejs.org/"/>,
			' & ',
