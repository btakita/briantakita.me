...
<p>
	{[
		...
		<Cite id="early-freelance-projects" ctx={props.ctx} innerHTML={[
...
<p>
	{[
		...
		<code>describe</code>,
		` statements`,
		<Cite id="nested-describe-statements" ctx={props.ctx} innerHTML={[
...
<p>
	{[
		...
		<Cite id={'context-of-entity'} ctx={props.ctx} innerHTML={[
...
<p>
	{[
		...
		<Cite id="tag-vector-development-continues" ctx={props.ctx}>
...
<p>
	{[
		...
		<Cite id="suppressthis-org" ctx={props.ctx}>
...
<p>
	{[
		...
		<Cite id="vanjs-tradeoff" ctx={props.ctx}>
...
<p>
	{[
		...
		<Atb_astrojs/>,
		` isomorphic Java=7[5script MPA development gained prominence. Marko was built almost a decade earlier, but Astro
...
<p>
	{[
		...
		<Cite id="agile_Agile" ctx={props.ctx} innerHTML={[
