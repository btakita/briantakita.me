...
import { ctx_core__tb_a_ } from '@btakita/ui--server--briantakita'
...
<R $={p_(
	`This series about Tag Vector will go over a technique that I have iterated on since 2016 in `, ctx_core__tb_a_(), `
...
<ul>
	...
	<li>
		<R $={[
			...
			footnote_c_({ ctx, id: 'font-ligatures' },
	...
	<li>
		<R $={[
			...
			footnote_c_({ ctx, id: 'tag-vector-editor-prototype' },
