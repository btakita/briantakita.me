...
import TOC_tuag_vector from '../../components/TOC_tag_vector.mdx'
...
<ul>
	...
	<li>
		{[
			...
			<Footnote id="font-ligatures" ctx={props.ctx}>
	...
	<li>
		{[
			...
			<Footnote id="tag-vector-editor-prototype" ctx={props.ctx}>
