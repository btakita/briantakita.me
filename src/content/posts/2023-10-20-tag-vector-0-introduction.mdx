...
import { atb_ctx_core_ } from '@btakita/ui--server--briantakita'
...
<R $={p_(
	`This series about Tag Vector will go over a technique that I have iterated on since 2016 in `, atb_ctx_core_(), `
