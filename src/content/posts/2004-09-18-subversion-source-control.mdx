...
<p>
	{[
		...
		<Van dom={V_atb_subversion({ ...props, innerText: 'Subversion Source Control' })}/>,
		`.`
	]}
</p>
<p>
	{[
		`I've used `,
		<Van dom={V_atb_ms_source_safe(props)}/>,
		`, `,
		<Van dom={V_atb_vault_scm(props)}/>,
		`, `,
		<Van dom={V_atb_cvs_scm(props)}/>,
...
<p>
	{[
		...
		<Van dom={V_atb_tortoisesvn(props)}/>,
