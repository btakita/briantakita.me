...
Philosophies are conceptual models. Conceptual models have a ${atb_domain_specific_language_()}. If we expand	the scope of certain definitions, we have the ability to expand consciousness. If we are able to make more	associations between concepts, consciousness expands.
...
# A tool to explore ${atb_existence_()}
...
# ${atb_abstraction_()}, ${atb_scope_()}, Zooming In/Out
