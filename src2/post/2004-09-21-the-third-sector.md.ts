...
// @formatter:off
// language=md
export default ()=>md_c_(` ${blog_post__top_note_p_(`Originally posted on `, tb_a_({ href: 'https://web.archive.org/web/20130407190308/http://geekswithblogs.net/btakita/archive/2004/09/21/11444.aspx' }, 'geekswithblogs.net'))}
