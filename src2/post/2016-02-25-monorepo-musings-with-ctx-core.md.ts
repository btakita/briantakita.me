...
import { atb_meteorjs_ } from '@btakita/ui--server--briantakita/anchor'
import { details_, span_, summary_ } from 'relementjs/html'
export const meta = {
	title: `Monorepo Musings with ctx-core`,
	author: `Brian Takita`,
	pubDate: '2016-02-25T11:00:00.000Z',
