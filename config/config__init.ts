...
export function config__init() {
	...
	jsonld_Person_id_ref_(app_ctx)
	jsonld_WebSite_id_ref_(app_ctx)
	jsonld_Organization_id_ref_(app_ctx)
	jsonld_AboutPage_id_ref_(app_ctx)
	jsonld_ContactPage_id_ref_(app_ctx)
